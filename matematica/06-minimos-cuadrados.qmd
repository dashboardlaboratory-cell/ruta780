...
Las ecuaciones normales no son solo una receta de cálculo: son $p$ identidades que se cumplen **siempre**, con cualquier conjunto de datos y sin ningún supuesto estadístico.
...
El apartado (4) le quita todo el misterio a $R^2$: no es una medida de calidad caída del cielo, es **cuánto apunta $y$ hacia el espacio columna**, medido con el mismo coseno de la lección 4. Y el apartado (1) explica por qué los residuos de una regresión con intercepto suman cero exactamente: no es una propiedad de los datos, es una ecuación que el ajuste resuelve.
