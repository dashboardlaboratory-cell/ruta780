...
- **Lección 1**: la [distribución muestral]{.g} de $\bar{x}$ se dibujó ahí por simulación. Esta lección dice cuál es su forma.
- **Lección 1**: la ley $\sigma/\sqrt{n}$ (Definición 1.7) se enunció sin demostrar; aquí se demuestra.
- **Lección 3**: la [normal]{.g} se presentó como familia sin justificar por qué aparece tanto. Esta lección es esa justificación.
...
- **Lección 7**: la [distribución muestral]{.g} normal es lo que permite hablar de la precisión de un [estimador]{.g}.
...
La estandarización fija la media en 0 y la varianza en 1, así que los dos primeros momentos ya no distinguen nada. Los momentos de orden superior, la [asimetría]{.g} y la [curtosis]{.g} de la lección 4, sí distinguen, pero al sumar $n$ copias independientes se diluyen: la asimetría de $Z_n$ resulta ser la de $X$ dividida entre $\sqrt{n}$, y la curtosis en exceso, la de $X$ dividida entre $n$. Ambas tienden a cero, que son los valores de la normal.

**Lo que afirma el teorema es que sumar borra la información de forma**, que es una propiedad de la operación y no una preferencia de la naturaleza por la campana.

El dibujo de abajo suma copias de la distribución que se elija y estandariza el resultado.
...
El primer caso conviene mirarlo con detalle porque el fallo se ve en una tabla. La distribución de Cauchy cumple que **la media de $n$ observaciones de una Cauchy es de nuevo una Cauchy, con la misma dispersión**. Promediar mil valores no reduce nada.
