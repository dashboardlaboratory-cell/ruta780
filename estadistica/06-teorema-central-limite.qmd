...
siguientes: [estadistica/07-normal-multivariante, estadistica/08-estimacion]
...
- **Lección 8**: la [distribución muestral]{.g} normal es lo que permite hablar de la precisión de un [estimador]{.g}.
- **Lección 10**: un intervalo de confianza al 95 % usa el 1.96 que sale de la normal.
- **Lección 11**: casi toda prueba de hipótesis clásica compara un estadístico contra una normal.
- **Lección 12**: el bootstrap existe precisamente para los casos en que este teorema no se aplica o $n$ es pequeño.
...
→ Siguiente: [Distribución normal multivariante](07-normal-multivariante.qmd)
